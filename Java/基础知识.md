...
JDK（Java Development Kit，Java开发工具包）
    ...
    |   └ 核心类库
    └ 开发工具（java.exe、javac.exe、javaw.exe等）
        ├ java.exe：运行java程序
        ├ javac.exe：编译工具，生成.class文件
        └ javaw.exe：运行GUI程序
```
...
```java
Java源代码---->编译器---->jvm可执行的Java字节码(即虚拟指令)---->
...
**封装**
封装把一个对象的属性私有化，隐藏对象的属性和实现细节，仅对外提供公共访问方式，将变化隔离，便于使用，提高复用性和安全性。
